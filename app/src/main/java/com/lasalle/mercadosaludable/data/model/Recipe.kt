...
/**
 * Entidad que representa una receta saludable en la base de datos.
 * Contiene información nutricional, ingredientes y clasificación por condición médica.
 */
...
data class Recipe(
    ...
    val calories: Int, // Calorías
    val protein: Double, // Proteínas en gramos
    val carbohydrates: Double, // Carbohidratos en gramos
    val fats: Double, // Grasas en gramos
    val fiber: Double, // Fibra en gramos
    val sodium: Double, // Sodio en mg
    val sugar: Double, // Azúcar en gramos
    ...
    // Tiempo y dificultad
    val preparationTime: Int, // Tiempo en minutos
    val difficulty: String, // "Fácil", "Media", "Difícil"
    val servings: Int, // Número de porciones

    // Costo estimado
    val estimatedCost: Double, // Costo en soles
